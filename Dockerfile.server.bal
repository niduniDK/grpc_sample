...
# This Dockerfile creates an image that contains the Ballerina greeter server.
...
COPY --from=builder /app/target/bin/*.jar ./
...
# Set the entrypoint to run the Ballerina application
